...
/*  Created On : 28-окт.-2023 02:52:30 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	category_subcategory_id bigint NULL,
...
CREATE INDEX "IXFK_M2M_order_product_M2M_Product_Size_Color" ON "M2M_order_product" (m2m_order_product_product_id ASC)
;
...
ALTER TABLE "M2M_order_product" ADD CONSTRAINT "FK_M2M_order_product_M2M_Product_Size_Color"
	FOREIGN KEY (m2m_order_product_product_id) REFERENCES "M2M_Product_Size_Color" ("M2M_PSC_id") ON DELETE No Action ON UPDATE No Action
;
